...
use anchor_spl::dex;
use serum_dex_0_4_0::instruction::MarketInstruction;
...
pub mod permissioned_markets {
    ...
    pub fn dex_instruction(
        ...
        if let Some((ix, accounts, seeds)) = pre_instruction {
            ...
            safecoin_program::program::invoke_signed(&ix, &accounts, &signers)?;
        }
        ...
        safecoin_program::program::invoke_signed(&ix, &acc_infos, &[seeds, seeds_init])?;
...
pub mod referral {
    safecoin_program::declare_id!("2k1bb16Hu7ocviT2KC3wcCgETtnC8tEUuvFBH4C5xStG");
}
