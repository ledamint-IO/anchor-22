...
use serum_dex_0_4_0::instruction::{MarketInstruction, NewOrderInstructionV3, SelfTradeBehavior};
use serum_dex_0_4_0::matching::{OrderType, Side};
use serum_dex_0_4_0::state::gen_vault_signer_key;
use serum_dex_0_4_0::state::Event;
use serum_dex_0_4_0::state::EventQueueHeader;
use serum_dex_0_4_0::state::MarketState;
use serum_dex_0_4_0::state::QueueHeader;
use serum_dex_0_4_0::state::Request;
use serum_dex_0_4_0::state::RequestQueueHeader;
...
fn remove_dex_account_padding<'a>(data: &'a [u8]) -> Result<Cow<'a, [u64]>> {
    use serum_dex_0_4_0::state::{ACCOUNT_HEAD_PADDING, ACCOUNT_TAIL_PADDING};
    ...
    let orders_pubkey = match *orders {
        ...
        None => {
            let (orders_key, instruction) = create_dex_account(
                ...
                program_id,
                &payer.pubkey(),
                size_of::<serum_dex_0_4_0::state::OpenOrders>(),
            )?;
...
pub fn list_market(
    ...
    let init_market_instruction = serum_dex_0_4_0::instruction::initialize_market(
        &market_key.pubkey(),
        program_id,
        coin_mint,
        pc_mint,
