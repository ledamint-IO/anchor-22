...
fn send_from_vault<'a, 'b: 'a>(
    ...
    safe_token_program: account_parser::SplTokenProgram<'a, 'b>,
...
pub(crate) mod account_parser {
    ...
    pub struct InitializeMarketArgs<'a, 'b: 'a> {
        ...
        serum_dex_0_4_0_accounts: &'a [AccountInfo<'b>; 5],
    ...
    impl<'a, 'b: 'a> InitializeMarketArgs<'a, 'b> {
        pub fn new(
            ...
            let (unchecked_serum_dex_0_4_0_accounts, unchecked_vaults, unchecked_mints, unchecked_rent) =
            ...
            for account in unchecked_serum_dex_0_4_0_accounts {
            ...
            let serum_dex_0_4_0_accounts = unchecked_serum_dex_0_4_0_accounts;
            let vault_owner_key_bytes = gen_vault_signer_key(
                instruction.vault_signer_nonce,
                serum_dex_0_4_0_accounts[0].key,
                program_id,
            )?
            .to_bytes();
            for i in 0..=1 {
        ...
        pub fn get_market(&self) -> &'a AccountInfo<'b> {
            &self.serum_dex_0_4_0_accounts[0]
        }

        pub fn get_req_q(&self) -> &'a AccountInfo<'b> {
            &self.serum_dex_0_4_0_accounts[1]
        }

        pub fn get_event_q(&self) -> &'a AccountInfo<'b> {
            &self.serum_dex_0_4_0_accounts[2]
        }

        pub fn get_bids(&self) -> &'a AccountInfo<'b> {
            &self.serum_dex_0_4_0_accounts[3]
        }

        pub fn get_asks(&self) -> &'a AccountInfo<'b> {
            &self.serum_dex_0_4_0_accounts[4]
        }
    }
    ...
    pub struct SendTakeArgs<'a, 'b: 'a> {
        ...
        pub safe_token_program: SplTokenProgram<'a, 'b>,
    ...
    impl<'a, 'b: 'a> SendTakeArgs<'a, 'b> {
        pub fn with_parsed_args<T>(
            ...
            let safe_token_program = SplTokenProgram::new(safe_token_program_acc)?;
    ...
    impl<'a, 'b: 'a> SweepFeesArgs<'a, 'b> {
        pub fn with_parsed_args<T>(
            ...
            let vault_signer = VaultSigner::new(vault_signer_acc, &market, program_id)?;
            let safe_token_program = SplTokenProgram::new(safe_token_program)?;
