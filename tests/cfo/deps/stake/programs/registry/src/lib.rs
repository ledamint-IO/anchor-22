...
use anchor_lang::safecoin_program::program_option::COption;
...
mod registry {
    ...
    pub fn drop_reward(
            ...
            || ctx.accounts.registrar.to_account_info().key == &msrm_registrar::ID
        {
            ...
            //       variables.
            safecoin_program::msg!("Reward amount not constrained. Please open a pull request.");
        }
...
pub mod srm_registrar {
    safecoin_program::declare_id!("5vJRzKtcp4fJxqmR7qzajkaKSiAb6aT9grRsaZKXU222");
}
pub mod msrm_registrar {
    safecoin_program::declare_id!("7uURiX2DwCpRuMFebKSkFtX9v5GK1Cd8nWLL8tyoyxZY");
}
pub mod fida_registrar {
    safecoin_program::declare_id!("5C2ayX1E2SJ5kKEmDCA9ue9eeo3EPR34QFrhyzbbs3qh");
}
pub mod dxl_registrar {
    safecoin_program::declare_id!("BQtp3xGPTFXJSt1MVKxtVSefRcBWmUkzTNM3g1t9efcK");
}
pub mod srm_mint {
    safecoin_program::declare_id!("SRMuApVNdxXokk5GT7XD5cUUgXMBCoAz2LHeuAoKWRt");
}
pub mod fida_mint {
    safecoin_program::declare_id!("EchesyfXePKdLtoiZSL8pBe8Myagyy8ZRqsACNCFGnvp");
}
pub mod dxl_mint {
    safecoin_program::declare_id!("GsNzxJfFn6zQdJGeYsupJWzUAm57Ba7335mfhWvFiE9Z");
}
