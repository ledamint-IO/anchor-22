    ...
    quote! {
        ...
        pub fn entry(program_id: &Pubkey, accounts: &[AccountInfo], data: &[u8]) -> ProgramResult {
            ...
            dispatch(program_id, accounts, data)
                .map_err(|e| {
                    anchor_lang::safecoin_program::msg!(&e.to_string());
                    e
                })
        }
        ...
        pub mod program {
            ...
            impl anchor_lang::AccountDeserialize for #name {
                fn try_deserialize(buf: &mut &[u8]) -> std::result::Result<Self, anchor_lang::safecoin_program::program_error::ProgramError> {
                    #name::try_deserialize_unchecked(buf)
                }

                fn try_deserialize_unchecked(_buf: &mut &[u8]) -> std::result::Result<Self, anchor_lang::safecoin_program::program_error::ProgramError> {
                    Ok(#name)
                }
            }
