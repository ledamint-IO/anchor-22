...
pub fn generate(error: Error) -> proc_macro2::TokenStream {
    ...
    quote! {
        ...
        pub enum Error {
            #[error(transparent)]
            ProgramError(#[from] anchor_lang::safecoin_program::program_error::ProgramError),
            #[error(transparent)]
        ...
        impl std::convert::From<Error> for anchor_lang::safecoin_program::program_error::ProgramError {
            fn from(e: Error) -> anchor_lang::safecoin_program::program_error::ProgramError {
                match e {
                    ...
                    Error::ErrorCode(c) => anchor_lang::safecoin_program::program_error::ProgramError::Custom(c as u32 + #offset),
                }
            }
        }

        impl std::convert::From<#enum_name> for anchor_lang::safecoin_program::program_error::ProgramError {
            fn from(e: #enum_name) -> anchor_lang::safecoin_program::program_error::ProgramError {
