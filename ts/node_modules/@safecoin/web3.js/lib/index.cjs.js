...
class Struct {
  ...
  encode() {
    return buffer.Buffer.from(borsh.serialize(SAFEANA_SCHEMA, this));
  }

  static decode(data) {
    return borsh.deserialize(SAFEANA_SCHEMA, this, data);
  }

  static decodeUnchecked(data) {
    return borsh.deserializeUnchecked(SAFEANA_SCHEMA, this, data);
  }
